...
class Client:
    ...
    def writeData(self, dataVal, tag):
        ...
        """
        assert type(
            dataVal) == list, "The data you provided is not arranged as a list. See the instructions for passing data to the server."
        ...
        try:
            ...
            print("Write operation by:", self.type, " failed @ time:",
    ...
    def readData(self, tag):
        ...
        try:
            ...
            print("A read operation by:", self.type, "failed @ time: ",
                  time.strftime('%Y-%m-%d %H:%M %Z', time.localtime()))
        return dataVal
    ...
    def checkFlags(self, pos=-1):
        ...
        try:
            ...
            print("A read operation attempted by the base client failed @ time: ",
                  time.strftime('%Y-%m-%d %H:%M %Z', time.localtime()))
        if pos == -1:
            result = dataVal
        else:
    ...
    def updateFlags(self, pos=0, flagVal=[]):
        ...
        """
        assert type(
            flagVal) == list, "The flag data you provided is not arranged as a list. See the instructions for passing data to the server."
        ...
        try:
            ...
            print("A write operation by the base client failed @ time:",
                  time.strftime('%Y-%m-%d %H:%M %Z', time.localtime()))
            return False
        return wr_result
    ...
    def checkSwitches(self, pos=-1):
        ...
        try:
            ...
            print("A status read operation attempted by the base client failed @ time: ",
                  time.strftime('%Y-%m-%d %H:%M %Z', time.localtime()))
        if pos == -1:
            result = dataVal
        else:
    ...
    def updateSwitches(self, pos=3, switchVal=[1]):
        ...
        """
        assert type(
            switchVal) == list, "The flag data you provided is not arranged as a list. See the instructions for passing data to the server."
        ...
        try:
            ...
            print("A write operation by:", self.type, " failed @ time:",
                  time.strftime('%Y-%m-%d %H:%M %Z', time.localtime()))
            return False
        return wr_result